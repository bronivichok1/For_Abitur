...
<legend className="text-center">{t('AppDetails')}</legend>        
        <div className="row">
            <label className="form-label">{t('Surname')}<span>*</span>
            ...
            <label className="form-label">{t('Name')}<span>*</span>
                ...
                <div className="row">
                    <label className="form-label">{t('SurnameRus')}<span>*</span>
                    ...
                    <label className="form-label" >{t('NameRus')}<span>*</span>
                ...
                <div className="row">
                    <label className="form-label">{!showInput&&t('Surname_info')}{showInput&&t('Surname_infoNext')}
                ...
                <div className="row">
                    <label className="form-label">{t('Gender')}<span >*</span>
                    ...
                    <label className="form-label">{t('Nationality')}<span >*</span>
                    ...
                    <label className="form-label">{t('DateOfBirth')}<span >*</span>
                ...
                <div className="row">
                    <label className="form-label">{t('Town')}<span>*</span>
                    ...
                    <label className="form-label">{t('Country')} <span>*</span>
            ...
            <div className="row">
                <label className="form-label">{t('Number')}
                ...
                <label className="form-label">{t('Religion')}
            ...
            <div className="row">
                <label className="form-label">{t('PhoneNumber')}<span >*</span>
                ...
                <label className="form-label">{t('Email')}<span >*</span>
            ...
            <div className="row">
                <label className="form-label">{!showInputDataPeople&&t('DataYourPeople')}{showInputDataPeople&&t('DataYourPeopleNext')}
            ...
            <div className="row">
                    <label className="form-label">{t('NameSurname')}
                    ...
                    <label className="form-label" >{t('PhoneRepresantative')}
        ...
        <hr/>
            ...
            <div className="row">
                    <label className="form-label">{t('serialPass')}
                    ...
                    <label className="form-label">{t('PassNumber')}<span >*</span>
                    ...
                    <label className="form-label">{t('CountryPass')} <span>*</span>
                    ...
                    <div className="row">
                        <label className="form-label">{t('PlaceOfIssue')}<span>*</span>
                        ...
                        <label className="form-label">{t('DataOfIssue')}<span >*</span>
                        ...
                        <label className="form-label">{t('DateOfExiry')}<span >*</span>
                    ...
                    <div className="row">
                        <label className="form-label">{t('NatPassw')}<span >*</span>
...
<legend className="text-center">{t('EducationInfo')}</legend>
                    <label className="form-label">{t('EducationInst')}<span ></span>
                ...
                <div className="row">
                    <label className="form-label">{t('EduSerialNumber')}<span ></span>
                    ...
                    <label className="form-label">{t('DataOfIssueEdu')}<span ></span>
...
<legend className="text-center">{t('InfoAdmission')}</legend>
                    <label className="form-label">{t('Faculty')}
...
<legend className="text-center">{t('AddDoc')}</legend>
                ...
                <div className="row">
                    <label  className="form-label">{t('AddFile1')}
                    </label>
                </div>
                <div className="row">
                    <label className="form-label">{t('AddFile2')}
                    </label>
                </div>
                <div className="row">
                    <label className="form-label">{t('AddFile3')}
                    </label>
                </div>
                <div className="row">
                    <label className="form-label">{t('AddFile4')}
                    </label>
                </div>
                <div className="row">
                    <label className="form-label">{t('AddFile5')}
                    </label>
                </div>
                <div className="row">
                    <label className="form-label">{t('AddFile6')}
                    </label>
                </div>
                <div className="row" >
                    <label className="form-label">{t('AddFile7')}
                    <div align="center">
                    </div >     
                    </label>
                </div>
